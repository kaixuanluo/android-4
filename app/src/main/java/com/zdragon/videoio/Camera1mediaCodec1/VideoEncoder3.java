...
public class VideoEncoder3 {
    ...
    CameraActivity3.EncodeListener mEncodeListener;

    public void setEncodeListener(CameraActivity3.EncodeListener encodeListener) {
        this.mEncodeListener = encodeListener;
    }

    public VideoEncoder3(int viewwidth, int viewheight){
        try {
