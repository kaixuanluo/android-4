...
public class VideoEncoder4 {
    ...
    CameraActivity4.EncodeListener mEncodeListener;

    public void setEncodeListener(CameraActivity4.EncodeListener encodeListener) {
        this.mEncodeListener = encodeListener;
    }

    public VideoEncoder4(int viewwidth, int viewheight){
        try {
